...
public class JavaRulesDefinition implements RulesDefinition {
	...
	public static final String REPOSITORY_KEY = "mulodo-java-rules";
	
	private static final String REPOSITORY_NAME = "Mulodo Repository";
	...
	public void define(Context context) {
		...
		for (Class<? extends JavaCheck> check : JavaCustomRulesList.getChecks()) {
